...
- Settings schema system (18 setting types including layout types, validation, migration)
- Settings renderer (schema → ImGui auto-generation with SectionCard support)
