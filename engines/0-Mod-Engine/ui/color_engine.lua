...
---@field IsWCAGCompliant fun(color1: ColorRGB, color2: ColorRGB, level: string): boolean
---@field GeneratePalette fun(accentRGB: ColorRGB): table
...
---@field Blend fun(color1: ColorRGB, color2: ColorRGB, factor: number): ColorRGB
---@field WithAlpha fun(r: number, g: number, b: number, a: number): ColorRGBA
---@field IsValidColor fun(color: any): boolean
---@field ClampColor fun(color: any): ColorRGBA
...
---@param accentRGB ColorRGB Accent color {r, g, b} (0-1)
...
---@param color1 ColorRGB First color {r, g, b}
---@param color2 ColorRGB Second color {r, g, b}
---@param factor number Blend factor (0 = color1, 1 = color2)
---@return ColorRGB Blended color {r, g, b}
...
---@return ColorRGBA Color with alpha {r, g, b, a}
...
---@param color ColorRGBA|nil Color table {r, g, b, a}
---@return ColorRGBA Clamped color
