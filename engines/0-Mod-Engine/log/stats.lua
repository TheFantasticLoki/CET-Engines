...
-- Module-level logger (set via setLogger)
---@type Logger?
local log = nil
...
---@type boolean Whether stats module has been initialized
local initialized = false
---@type table<string, LoggerInstance> Reference to the loggers table from init.lua
...
function M.getAggregateStats()
    ...
    if log then log.debug("Stats.getAggregateStats: " .. stats.totalMods .. " mods, " .. stats.totalLogged .. " total") end
    return stats
end
